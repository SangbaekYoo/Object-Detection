...
data_path = __file__.replace('utils/data_preprocess.py','')

img_data_dir_path = f'{data_path}dataset/trainset/'
label_data_path = f'{data_path}dataset/trainset_label.csv'
...
if __name__ == '__main__':
    ...
    df_label = pd.DataFrame(label_lib)
